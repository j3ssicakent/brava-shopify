  ...
  class VariantSelects extends HTMLElement {
    ...
    updateVariantText() {
      ...
      fieldsets.forEach((item, i) => {
        ...
        if (input && input.getAttribute('data-label')) {
          label.innerHTML = input.getAttribute('data-label');
        } else if (label) {
    ...
    renderProductInfo() {
      ...
      fetch(`${this.dataset.url}?variant=${this.currentVariant.id}&section_id=${this.dataset.section}`)
        ...
        .then((responseText) => {
          ...
          this.toggleAddButton(!this.currentVariant.available, window.theme.variantStrings.isUnavailable);
